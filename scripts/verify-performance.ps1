...
$savedEnvironment = @{}
foreach ($name in @('DB_NAME', 'DB_USERNAME', 'DB_PASSWORD', 'JWT_SECRET', 'CORS_ALLOWED_ORIGINS', 'SPRING_PROFILES_ACTIVE', 'RATE_LIMIT_MAX_PER_MINUTE', 'LOGIN_RATE_LIMIT_MAX_PER_MINUTE')) {
